...
<body>
<div class="row">
    <div class="tytul"><h3>Panel Użytkownika</h3></div>
    <div class="col">
        <a id="elem" href="zamowienia.php" class="panel-btn">Zamówienia</a>
        <a id="elem" href="rezerwacje.php" class="panel-btn">Rezerwacje</a>
        <a id="elem" href="reklamacje.php" class="panel-btn">Reklamacje</a>
    </div>
</div>
<a id="elem" href="index.php" class="order-btn">Wstecz</a>